...
describe("class method", function () {
    ...
    test_helpers_1.runClassMethodDefinitionTests(def.classes[0].methods[1], {
        name: "myExplicitReturnTypeMethod",
        scope: scope_1.Scope.public,
        returnType: "string",
        parameters: []
    });
    test_helpers_1.runClassMethodDefinitionTests(def.classes[0].methods[2], {
        name: "myImplicitReturnTypeMethod",
        scope: scope_1.Scope.public,
        returnType: "string",
        parameters: []
    });
    test_helpers_1.runClassMethodDefinitionTests(def.classes[0].methods[3], {
        name: "myPublicMethod",
        scope: scope_1.Scope.public,
        returnType: "void",
        parameters: []
    });
    test_helpers_1.runClassMethodDefinitionTests(def.classes[0].methods[4], {
        name: "myProtectedMethod",
        scope: scope_1.Scope.protected,
        returnType: "void",
        parameters: []
    });
    test_helpers_1.runClassMethodDefinitionTests(def.classes[0].methods[5], {
