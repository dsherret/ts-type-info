...
__export(require("./base/named-structure"));
__export(require("./base/decorator-structure"));
...
__export(require("./base/object-property-structure"));
__export(require("./base/type-parameter-structure"));
