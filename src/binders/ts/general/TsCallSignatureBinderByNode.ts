...
import {TsBaseDefinitionBinder, TsTypeParameteredBinderByNode, TsParameteredBinderByNode, TsReturnTypedBinderByNode, TsNodedBinder, TsDocumentationedBinder} from "./../base";
