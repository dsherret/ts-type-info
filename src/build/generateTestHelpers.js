...
generator.addOptInPropertyTransform(prop => prop.name === "definitions");
...
generator.addDefaultValue(prop => prop.name === "defaultExpression", `null`);
...
generator.addDefaultValue(prop => prop.name === "type", `{ text: "any" }`);
...
definitionNamedImportNames.push("VariableDeclarationType", "Scope", "ClassConstructorParameterScope", "ExportableDefinitions", "ClassPropertyKind", "NamespaceDeclarationType");
