...
import {ReExportTestStructure, ExpressionTestStructure} from "./../../test-structures";
...
function runImportPartTests(
    definition: { exportName: string; definitions: ArrayExt<ExportableDefinitions>; expression: Expression; },
