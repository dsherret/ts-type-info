...
export type WriteableTestStructures = FileTestStructure | NamespaceTestStructure | ClassTestStructure| InterfaceTestStructure | FunctionTestStructure | EnumTestStructure | VariableTestStructure;
...
export type ParameterTestStructures = FunctionParameterTestStructure | InterfaceMethodParameterTestStructure | ClassMethodParameterTestStructure | ClassStaticMethodParameterTestStructure |
                                   InterfaceNewSignatureParameterTestStructure | ClassConstructorParameterTestStructure | CallSignatureParameterTestStructure;
export type ParameteredTestStructures = FunctionTestStructure | InterfaceMethodTestStructure | ClassMethodTestStructure | InterfaceNewSignatureTestStructure | ClassConstructorTestStructure |
                                     CallSignatureTestStructure;
